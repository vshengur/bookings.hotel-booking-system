using BookingsService.Application.Common.Models;
using BookingsService.Application.TodoItems.Commands.CreateTodoItem;
using BookingsService.Application.TodoItems.Commands.DeleteTodoItem;
using BookingsService.Application.TodoItems.Commands.UpdateTodoItem;
using BookingsService.Application.TodoItems.Commands.UpdateTodoItemDetail;
using BookingsService.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace BookingsService.Web.Endpoints;
